...
public class WebDriver1 {
	...
	Element1 finder = null;
	Actions action  =null;

	public WebDriver1(WebDriver driver) {
		
		this.driver = driver;
		driver.manage().window().maximize();
		finder = new Element1(driver);
	...
	public void enterFrame(String frameID) {
		...
		Log1.info("Entered iframe " + frameID);
	}
	...
	public void enterFrame1(String locator) {
		...
		Log1.info("Entered iframe " + element);
	}


	public void leaveFrame() {
		driver.switchTo().defaultContent();
		Log1.info("Left the iframe");
	}
