...
function Date(props) {
    ...
    return (
        <List>
            <ListItem onClick={() => { }} style={{ marginLeft: '30px' }} platform="android"><NavLink to='/Case_maintenance' style={{ color: 'black' }}>用例维护</NavLink></ListItem>
            <ListItem onClick={() => { }} style={{ marginLeft: '30px' }} platform="android"><NavLink to='/Paper' style={{ color: 'black' }}>参数文件</NavLink></ListItem>
